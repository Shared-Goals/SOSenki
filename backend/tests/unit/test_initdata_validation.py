...
class TestInitDataValidation:
    ...
    def _create_valid_initdata_string(self, bot_token: str, user_id: int = 123456789, auth_date: int = None) -> tuple:
    ...
    def test_verify_initdata_signature_valid(self, test_telegram_id: int) -> None:
        ...
        initdata_string, expected_hash, auth_date, user_id = self._create_valid_initdata_string(bot_token, test_telegram_id)
    ...
    def test_verify_initdata_signature_invalid(self, test_telegram_id: int) -> None:
        ...
        """
        bot_token = "test_bot_token"
        initdata_string, correct_hash, auth_date, user_id = self._create_valid_initdata_string(bot_token, test_telegram_id)
    ...
    def test_initdata_timestamp_fresh(self, test_telegram_id: int) -> None:
        ...
        initdata_string, _, _, _ = self._create_valid_initdata_string(bot_token, test_telegram_id, current_time)
    ...
    def test_initdata_timestamp_expired(self, test_telegram_id: int) -> None:
        ...
        initdata_string, _, _, _ = self._create_valid_initdata_string(bot_token, test_telegram_id, old_time)
